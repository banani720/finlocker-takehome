...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 100670712, ; uint32_t jnienv_initialize_method_token (0x6001cf8)
	i32 100670711, ; uint32_t jnienv_registerjninatives_method_token (0x6001cf7)
...
@dso_cache = dso_local local_unnamed_addr global [504 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 2505441088163425908, ; hash 0x22c51d6531a62e74, from name: FinLockerTaskList
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-FinLockerTaskList.dll.so
		ptr null; void* handle (0x0)
	}, ; 61
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 3756997126897742294, ; hash 0x342388fb42e731d6, from name: aot-FinLockerTaskList.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-FinLockerTaskList.dll.so
		ptr null; void* handle (0x0)
	}, ; 104
	...
	%struct.DSOCacheEntry {
		i64 10248681578975877557, ; hash 0x8e3aa198a2f259b5, from name: aot-FinLockerTaskList
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-FinLockerTaskList.dll.so
		ptr null; void* handle (0x0)
	}, ; 272
	...
	%struct.DSOCacheEntry {
		i64 13656219999242098225, ; hash 0xbd84a3bc4d691631, from name: FinLockerTaskList.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-FinLockerTaskList.dll.so
		ptr null; void* handle (0x0)
	}, ; 371
	...
	%struct.DSOCacheEntry {
		i64 16378037334242404642, ; hash 0xe34a7a2e519aa922, from name: libaot-FinLockerTaskList
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-FinLockerTaskList.dll.so
		ptr null; void* handle (0x0)
	}, ; 450
	...
	%struct.DSOCacheEntry {
		i64 17229443347211025776, ; hash 0xef1b4770543afd70, from name: libaot-FinLockerTaskList.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-FinLockerTaskList.dll.so
		ptr null; void* handle (0x0)
	}, ; 470
...
@.env.3 = private unnamed_addr constant [37 x i8] c"dc6e8c21-26ca-4bfc-8d87-3ad44719fbbc\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [34 x i8] c"com.companyname.finlockertasklist\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [32 x i8] c"libaot-FinLockerTaskList.dll.so\00", align 16
