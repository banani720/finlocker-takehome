...
@dso_cache = dso_local local_unnamed_addr global [504 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 358595691, ; hash 0x155fbc6b, from name: aot-FinLockerTaskList
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 891183848, ; hash 0x351e62e8, from name: aot-FinLockerTaskList.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-FinLockerTaskList.dll.so
		ptr null; void* handle (0x0)
	}, ; 100
	...
	%struct.DSOCacheEntry {
		i64 1937021701, ; hash 0x73749b05, from name: libaot-FinLockerTaskList
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-FinLockerTaskList.dll.so
		ptr null; void* handle (0x0)
	}, ; 216
	...
	%struct.DSOCacheEntry {
		i64 2554693477, ; hash 0x98458765, from name: libaot-FinLockerTaskList.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-FinLockerTaskList.dll.so
		ptr null; void* handle (0x0)
	}, ; 297
	...
	%struct.DSOCacheEntry {
		i64 2898759909, ; hash 0xacc790e5, from name: FinLockerTaskList.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-FinLockerTaskList.dll.so
		ptr null; void* handle (0x0)
	}, ; 344
	...
	%struct.DSOCacheEntry {
		i64 4220564938, ; hash 0xfb90b5ca, from name: FinLockerTaskList
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-FinLockerTaskList.dll.so
		ptr null; void* handle (0x0)
	}, ; 497
